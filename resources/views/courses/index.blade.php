        ...
        <div class="mb-8">
            <form method="GET" action="{{ route('courses.index') }}">
                <div class="relative flex">
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Kurslarni qidirish..."
                    ...
                    <button type="submit" class="ml-2 px-4 py-3 bg-primary text-white rounded-md">
                        Izlash
                    </button>
                </div>
            </form>

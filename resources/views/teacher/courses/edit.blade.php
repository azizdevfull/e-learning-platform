...
@section('title', 'Kursni Tahrirlash: ' . $course->title)
        ...
        <div class="p-4 md:p-6">
            <div class="space-y-6">
                ...
                <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        <h2 class="text-3xl font-bold tracking-tight">Kursni Tahrirlash</h2>
                        <p class="text-gray-500">Kurs ma'lumotlarini yangilang.</p>
                    </div>

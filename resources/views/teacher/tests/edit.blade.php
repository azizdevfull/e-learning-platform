...
@section('title', 'Testni Tahrirlash: ' . $test->title)
        ...
        <div class="p-4 md:p-6">
            <div class="space-y-6">
                ...
                <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        <h2 class="text-3xl font-bold tracking-tight">Testni Tahrirlash</h2>
                        <p class="text-gray-500">Test nomi va kursni yangilang.</p>
                    </div>
                    ...
                    <form action="{{ route('teacher.tests.update', $test->id) }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="title" name="title" value="{{ old('title', $test->title) }}"

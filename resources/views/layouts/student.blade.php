        ...
        <div class="flex items-center justify-between h-16 px-4 md:px-6">
            ...
            <div class="hidden md:flex items-center space-x-1">
                ...
                <a href="{{ route('student.courses.index') }}" class="px-3 py-2 rounded-md hover:bg-gray-100">Mening
                    Kurslarim</a>
                <a href="{{ route('student.all.courses') }}" class="px-3 py-2 rounded-md hover:bg-gray-100">Barcha
                    Kurslar</a>
            ...
            <div class="py-2">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <a href="{{ route('student.all.courses') }}"
                        class="flex items-center gap-3 rounded-md px-3 py-2 text-sm transition-colors {{ request()->routeIs('student.all.*') ? 'bg-primary text-white' : 'hover:bg-sidebar-hover text-gray-600 hover:text-gray-900' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />

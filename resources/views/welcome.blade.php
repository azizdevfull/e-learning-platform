        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="#"
                    ...
                    data-category="mathematics">Matematika</a>
                <a href="#"
                    class="category-pill px-6 py-3 bg-secondary-light text-secondary font-medium rounded-full hover:bg-secondary hover:text-white"
                    data-category="programming">Dasturlash</a>
                <a href="#"
                    class="category-pill px-6 py-3 bg-accent-light text-accent font-medium rounded-full hover:bg-accent hover:text-white"
                    data-category="languages">Chet tillari</a>
                <a href="#"
                    class="category-pill px-6 py-3 bg-pastel-purple text-purple-600 font-medium rounded-full hover:bg-purple-600 hover:text-white"
                    data-category="science">Tabiiy fanlar</a>
                <a href="#"
                    class="category-pill px-6 py-3 bg-pastel-pink text-pink-600 font-medium rounded-full hover:bg-pink-600 hover:text-white"
                    data-category="art">San'at va dizayn</a>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden card-hover" data-category="mathematics">
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80"
                            alt="Algebra asoslari" class="w-full h-48 object-cover">
                        <div class="absolute top-4 left-4">
                            <span
                                class="px-3 py-1 bg-primary text-white text-xs font-semibold rounded-full">Matematika</span>
                        </div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">Algebra asoslari</h3>
                        <p class="text-gray-600 mb-4 line-clamp-2">Algebraning asosiy tushunchalari va formulalarini
                            o'rganing. Ushbu kurs orqali algebraik masalalarni yechish ko'nikmalarini
                            rivojlantirasiz.</p>
                ...
                <!-- Course Card 2 -->
                <div class="bg-white rounded-xl shadow-md overflow-hidden card-hover" data-category="programming">
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80"
                            alt="Web dasturlash" class="w-full h-48 object-cover">
                        <div class="absolute top-4 left-4">
                            <span
                                class="px-3 py-1 bg-secondary text-white text-xs font-semibold rounded-full">Dasturlash</span>
                        </div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">Web dasturlash asoslari</h3>
                        <p class="text-gray-600 mb-4 line-clamp-2">HTML, CSS va JavaScript asoslarini o'rganing va
                ...
                <!-- Course Card 3 -->
                <div class="bg-white rounded-xl shadow-md overflow-hidden card-hover" data-category="languages">
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80"
                            alt="Ingliz tili" class="w-full h-48 object-cover">
                        <div class="absolute top-4 left-4">
                            <span class="px-3 py-1 bg-accent text-white text-xs font-semibold rounded-full">Chet
                                tillari</span>
                        </div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">Ingliz tili: Boshlang'ich daraja</h3>
                        <p class="text-gray-600 mb-4 line-clamp-2">Ingliz tilini noldan o'rganing. Kundalik muloqot
                ...
                <!-- Course Card 4 -->
                <div class="bg-white rounded-xl shadow-md overflow-hidden card-hover" data-category="science">
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80"
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">Fizika asoslari</h3>
                        <p class="text-gray-600 mb-4 line-clamp-2">Fizikaning asosiy qonunlari va tushunchalarini
                ...
                <!-- Course Card 5 -->
                <div class="bg-white rounded-xl shadow-md overflow-hidden card-hover" data-category="art">
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80"
                            alt="Grafik dizayn" class="w-full h-48 object-cover">
                        <div class="absolute top-4 left-4">
                            <span class="px-3 py-1 bg-pink-600 text-white text-xs font-semibold rounded-full">San'at
                                va dizayn</span>
                        </div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">Grafik dizayn asoslari</h3>
                        <p class="text-gray-600 mb-4 line-clamp-2">Grafik dizayn asoslarini o'rganing va o'z
                            loyihalaringizni yarating. Adobe Photoshop va Illustrator dasturlari bilan ishlashni
                            o'rganing.</p>
                        <div class="flex items-center text-sm text-gray-500 mb-4">
                            <div class="flex items-center mr-4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24"
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden card-hover" data-category="programming">
                    <div class="relative">
                        <img src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400&q=80"
                            alt="Python dasturlash" class="w-full h-48 object-cover">
                        <div class="absolute top-4 left-4">
                            <span
                                class="px-3 py-1 bg-secondary text-white text-xs font-semibold rounded-full">Dasturlash</span>
                        </div>
                    ...
                    <div class="p-6">
                        <h3 class="text-xl font-bold mb-2">Python dasturlash tili</h3>
                        <p class="text-gray-600 mb-4 line-clamp-2">Python dasturlash tilini noldan o'rganing.
